...
`skipchr` provides zero-allocation, `no_std`-compatible functions to skip,
...
`skipchr` is dual-licensed under the MIT license and the Apache License (Version 2.0).
...
[zh-cn-url]: https://github.com/al8n/skipchr/tree/main/README-zh_CN.md
